...
$(() => {
  ...
  $newReservationForm.on('submit', function(event) {
    ...
    alert("you submitted $newReservationForm");
  ...
  const createListing = function(property, isReservation, isReservable) {
  ...
  console.log('$newReservationForm:', $newReservationForm);
